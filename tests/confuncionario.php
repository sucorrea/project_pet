                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="d-flex flex-column">
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> Função: <?php echo htmlspecialchars($_SESSION["funcao"]); ?></span>
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Departamento: <?php echo htmlspecialchars($_SESSION["departamento"]); ?></span>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <form class="form-inline">
                                        ...
                                        <span>
                                            <?php echo (($_SESSION["id_funcao"] == 1))
                                                ? '<button href="./addfuncionario.html" class="btn btn-primary ml-1" title="Cadastrar"><i class="fas fa-fw fa-plus"></i></button>'
                                                : '<button href="./addfuncionario.html" class="btn btn-primary ml-1" title="Cadastrar" disabled><i class="fas fa-fw fa-plus"></i></button>';
                                            ?>
                                        </span>
                                    </form>
                                                ...
                                                <div class="modal-content p-3">
                                                    ...
                                                    <div class="mt-3">
                                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="funcao-tab" data-bs-toggle="tab" href="#funcao" role="tab" aria-controls="funcao" aria-selected="false">Função</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                        ...
                                                        <div class="tab-pane fade show active" id="pessoa" role="tabpanel" aria-labelledby="pessoa-tab">
                                                            ...
                                                            <div class="container mt-4 mb-5">
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-circle" title="Voltar"><i class="fas fa-fw fa-chevron-left"></i></button>
                                                                    <div class="ml-auto">
                                                                        <button type="submit" class="btn btn-primary btn-circle" title="Avançar"><i class="fas fa-fw fa-chevron-right"></i></button>
                                                                    </div>
                                                        ...
                                                        <div class="tab-pane fade" id="funcao" role="tabpanel" aria-labelledby="funcao-tab">
                                                            ...
                                                            <div class="container mt-5 mb-4">
                                                                <div class="row">
                                                                    <div class="col-4 mb-3">
                                                                        ...
                                                                        <select class='form-control' name='select-funcao'>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col mb-3">
                                                                        <label for="hora_de_trab" class="form-label">Horário de
                                                                            Trabalho</label>
                                                            ...
                                                            <div class="container mt-4 mb-5">
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-circle" title="Voltar"><i class="fas fa-fw fa-chevron-left"></i></button>
                                                                    <div class="ml-auto">
                                                                        <a href="confuncionario2.html" class="btn btn-success btn-circle" title="Salvar"><i class="fas fa-fw fa-chevron-down"></i></a>
                                                                        <a href="confuncionario.php" class="btn btn-danger btn-circle" title="Cancelar"><i class="fas fa-fw fa-xmark"></i></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="tab-pane fade" id="endereco" role="tabpanel" aria-labelledby="endereco-tab">
                                                            ...
                                                            <div class="container mt-5 mb-5">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="rua" name="rua" placeholder="Digite o logradouro">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col mb-3">
                                                                        <label for="pontoreferencia" class="form-label">Ponto de
                                                                            Referência</label>
                                                            ...
                                                            <div class="container mt-4 mb-5">
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary btn-circle" title="Voltar"><i class="fas fa-fw fa-chevron-left"></i></button>
                                                                    <div class="ml-auto">
                                                                        <a data-bs-toggle="tab" href="#endereco" role="tab" aria-controls="endereco" aria-selected="false" class="btn btn-primary btn-circle" title="Avançar"><i class="fas fa-fw fa-chevron-right"></i></a>
                                                                    </div>
                                        ...
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="confuncionario2.html">brenda.gimenes@outlook.com</a>
                                                    </td>
                                                    <td><a href="confuncionario2.html">03/06/2023</a></td>
                                                </tr>
                                                <tr>
